...
abstract class Less_Config extends Pimcore_API_Plugin_Abstract implements Pimcore_API_Plugin_Interface {
    ...
    protected static function getSettingsConfigPath() {
        return PIMCORE_PLUGINS_PATH . '/Less/install/website.xml';                
    }
